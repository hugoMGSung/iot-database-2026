...
INSERT INTO `Book` VALUES (1,'축구의 역사','굿스포츠',7000),(2,'축구 아는 여자','나무수',13000),(3,'축구의 이해','대한미디어',22000),(4,'골프 바이블','대한미디어',35000),(5,'피겨 교본','굿스포츠',8000),(6,'배구 단계별기술','굿스포츠',6000),(7,'야구의 추억','이상미디어',20000),(8,'야구를 부탁해','이상미디어',13000),(9,'올림픽 이야기','삼성당',7500),(10,'Olympic Champions','Pearson',13000),(14,'스포츠의학3','Human Kinetics',NULL),(21,'Zen Golf','Pearson',12000),(22,'Soccer Skills','Human Kinetics',15000),(31,'살면서 한번은 벽돌','글항아리',19500),(32,'100년 쓰는 완벽 허리','한즈미디어',19800),(33,'60일 영어 습관','시원스쿨닷컴',18900),(40,'에이리언 어스','20세기미디어',20000);
...
CREATE TABLE `Idx_Book` (
  `bookid` int NOT NULL,
  `bookname` varchar(40) DEFAULT NULL,
  `publiser` varchar(40) DEFAULT NULL,
...
-- Dump completed on 2026-03-20 16:15:05
