...
SELECT * FROM inventory
 WHERE film_id IN (1,
14,33,36,38,41,87,108,128,144,148,171,192,195,198,217,221,318,325,332,
359,386,404,419,495,497,607,642,669,671,701,712,713,742,801,802,860,
...
-- 6. Gildong Hong 의 이메일 주소를 수정하세요
UPDATE customer
